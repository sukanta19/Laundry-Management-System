 ...
 * @author iimsu
 */
public class MonthlySalesReportNewJInternalFrame11 extends javax.swing.JInternalFrame {
    ...
    public MonthlySalesReportNewJInternalFrame11() {
        initComponents();
    }
    
    public MonthlySalesReportNewJInternalFrame11(String uid) {
        initComponents();
        userid=uid;
        fileContent="";
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try
        {
            ...
            String dt=""; 
                ...
                String mon=jTextField1.getText().trim();
                ...
                int y=Integer.parseInt(yr);
                 ...
                 String sql="select distinct order_id,date_of_order, sum(price) as sm from service_order where user_id='"+userid+"'  and status='"+statusid+"'"+" and month(date_of_order)="+mon+" and year(date_of_order)="+yr+" group by order_id ";                                  
                 ...
                 {
                     JFrame f=new JFrame();
                     JOptionPane.showMessageDialog(f,"Enter month MM and year YYYY format","SS-LMS 19.2K",JOptionPane.WARNING_MESSAGE);              
                 }             
        }
