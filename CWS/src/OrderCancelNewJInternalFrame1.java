 ...
 * @author iimsu
 */
public class OrderCancelNewJInternalFrame1 extends javax.swing.JInternalFrame {
    ...
    public OrderCancelNewJInternalFrame1() {
        initComponents();
    }
    
    public OrderCancelNewJInternalFrame1(String uid) {
        initComponents();
        userid=uid;
        fileContent="";    
    ...
    private void initComponents() {
        ...
        jButton4.setText("C ancel Order");
  ...
  String Q="";
        ...
        try
        {
            ...
            boolean flag1=true;
            if(jTextField4.getText().equalsIgnoreCase("Delivered")==true)
            {
                flag1=false;
                JFrame f=new JFrame();
                JOptionPane.showMessageDialog(f,"Some Fields are empty or Invalid Data Entry","SS-LMS 19.2K",JOptionPane.WARNING_MESSAGE);
            ...
            {
                  String st1="Cancelled";                 
                  String sql="Update service_order set status='"+st1+"'    where order_id='"+st2+"' ";            
                 int rs=stmt.executeUpdate(sql);              
                    JFrame f=new JFrame();
                    JOptionPane.showMessageDialog(f,"Order ID: "+st2+" has Cancelled Sucessfully","SS-LMS 19.2K",JOptionPane.WARNING_MESSAGE);                
                    this.dispose();
            }
        }
        ...
        {
            JFrame f=new JFrame();
            JOptionPane.showMessageDialog(f,"Data Selection error or Order ID does not exist"+e,"SS-LMS 19.2K",JOptionPane.WARNING_MESSAGE);
        }
